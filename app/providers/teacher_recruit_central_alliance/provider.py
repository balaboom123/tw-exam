...
class CentralAllianceRecruitProvider(SourceProvider):
    provider_id = "teacher_recruit_central_alliance"

    def __init__(self, client: CentralAllianceRecruitClient | None = None) -> None:
        self.client = client or CentralAllianceRecruitClient()
