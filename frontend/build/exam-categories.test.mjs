...
import { CLASS_ORDER, orderExamClasses, orderExamSubclasses } from "../src/lib/exam-categories.ts"
...
test("new feed classes are visible after the known display order", () => {
